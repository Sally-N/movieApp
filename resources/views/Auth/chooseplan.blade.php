...
<div class="container-plan">
 ...
 <div class="row">
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Mini Plan</h5>
                <h6 class="subtitle">Features</h6>
  <ul>
            <li>
SD streaming quality
            ...
            <li>
                Download shows to watch offline on your mobile or tablet
            </li>
<li>99ksh per month</li>
        </ul>     
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Maxi Plan</h5>
        <h6 class="subtitle">Features</h6>
        <ul>
            <li>
            SD streaming quality
            ...
            <li>
                Access to family and children shows
            </li>
            <li>299ksh per month</li>
        </ul>
        <a href="#" class="btn btn-primary">Select</a>
      </div>
    </div>
  ...
  <div class="col-sm-4">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Mega Plan</h5>
                <h6 class="subtitle">Features</h6>
          <ul>
            <li>
            SD streaming quality
